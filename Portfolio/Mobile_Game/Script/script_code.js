    ...
    $(function () {
        ...
        function deplace() {
            $('#vr').animate({
                ...
                var vrX = Math.floor(Math.random() * 200) + 80, vrY = 500;
                $('#vr').css('top', vrY);
                $('#vr').css('left', vrX);
                ok = 1;
            });
        ...
        function collision() {
            ...
            var vjX = parseInt(($('#vj').css('left')), 10), vrX = parseInt(($('#vr').css('left')), 10), vjY = 10, vrY = parseInt(($('#vr').css('top')), 10);
            ...
            if (collision > 2) {
                ...
                if (voegScoreEenKeer === 1) {
                    ...
                    highScore.push({"naam": naam, "score": score});
    ...
    $(function () {
        ...
        function deplace() {
            $('#vr').animate({
                ...
                var vrX = Math.floor(Math.random() * 100) + 60, vrY = 500;
                $('#vr').css('top', vrY);
                $('#vr').css('left', vrX);
                ok = 1;
            });
            $('#vr2').animate({
                ...
                var vrX2 = Math.floor(Math.random() * 95) + 180, vrY = 500;
                $('#vr2').css('top', vrY);
                $('#vr2').css('left', vrX2);
                ok = 1;
            });
        ...
        function collision() {
            var vjX = parseInt(($('#vj').css('left')), 10), vrX = parseInt(($('#vr').css('left')), 10), vjY = 10, vrY = parseInt(($('#vr').css('top')), 10), vrY2 = parseInt(($('#vr2').css('top')), 10), vrX2 = parseInt(($('#vr2').css('left')), 10);
            if (((vrX > vjX) && (vrX < (vjX + 30)) && (vrY > vjY) && (vrY < (vjY + 75)) && (ok === 1)) || ((vjX > vrX) && (vjX < (vrX + 30)) && (vrY > vjY) && (vrY < (vjY + 75)) && (ok === 1))) {
                $('#son')[0].play();
                collision = parseInt($('#info').text()) + 1;
                $('#info').text(collision);
    ...
    $(function () {
        ...
        function deplace() {
            $('#vr').animate({
                ...
                var vrX = Math.floor(Math.random() * 70) + 50, vrY = 500;
                $('#vr').css('top', vrY);
                $('#vr').css('left', vrX);
                ok = 1;
            });
            $('#vr2').animate({
                ...
                var vrX2 = Math.floor(Math.random() * 40) + 160, vrY = 500;
                $('#vr2').css('top', vrY);
                $('#vr2').css('left', vrX2);
                ok = 1;
            });
            $('#vr3').animate({
                ...
                var vrX3 = Math.floor(Math.random() * 40) + 240, vrY = 500;
                $('#vr3').css('top', vrY);
                $('#vr3').css('left', vrX3);
                ok = 1;
            });
        ...
        function collision() {
            var vjX = parseInt(($('#vj').css('left')), 10), vrX = parseInt(($('#vr').css('left')), 10), vrX2 = parseInt(($('#vr2').css('left')), 10), vrX3 = parseInt(($('#vr3').css('left')), 10), vjY = 10, vrY = parseInt(($('#vr').css('top')), 10), vrY2 = parseInt(($('#vr2').css('top')), 10), vrY3 = parseInt(($('#vr3').css('top')), 10);
            if (((vrX > vjX) && (vrX < (vjX + 30)) && (vrY > vjY) && (vrY < (vjY + 75)) && (ok === 1)) || ((vjX > vrX) && (vjX < (vrX + 30)) && (vrY > vjY) && (vrY < (vjY + 75)) && (ok === 1))) {
                $('#son')[0].play();
                collision = parseInt($('#info').text()) + 1;
                $('#info').text(collision);
...
// De functie van het pauzeren van het spel
...
$(document).ready(function () {
    naam = "Jacques";
    score = "00:30";
    highScore = [{"naam": naam, "score": score }];
